...
export default class extends React.Component {
  constructor(props) {
    ...
    this.emotion = createEmotion({ nonce: 'a1b2c3d' });

    this.smallFilmCSS = this.emotion.css({
      maxWidth: 474 * 2
    });

    this.listFilmItemCSS = this.emotion.css({
      width: 200
    });
  }
    ...
    return (
      <div>
        ...
        <p>
          ...
          voluptate amet irure ut nostrud nostrud culpa ullamco dolore. Et eiusmod eiusmod ad excepteur sunt. Veniam
          ipsum eiusmod tempor in.
        </p>
        <p>
        ...
        <p>
          ...
          deserunt eiusmod ad id sit voluptate. Sit nulla et deserunt consequat culpa aliquip adipisicing. Velit ea id
          et id occaecat proident proident aliqua nostrud reprehenderit do aliqua. Irure nisi irure excepteur in eiusmod
          adipisicing nisi consectetur consectetur sit.
        </p>
        <p>
          Dolore ad sit voluptate esse exercitation cupidatat. Commodo excepteur sunt magna do sunt fugiat laboris non
          in Lorem proident aliqua tempor. Exercitation est ad laborum eu elit commodo dolore. Enim sint quis do
          incididunt duis minim veniam Lorem mollit ex nostrud deserunt. Pariatur fugiat sint eiusmod voluptate officia.
        </p>
        <p>
          In elit anim elit ea ex. Voluptate qui id laborum sit duis officia enim est velit sunt do. Amet aliqua
          occaecat laboris pariatur. Veniam eu reprehenderit ea esse officia esse dolor laborum deserunt. Laboris
          occaecat et aute nostrud consequat amet elit adipisicing non nostrud minim id voluptate sunt. Qui consequat
          veniam occaecat veniam dolor ex consequat. Ullamco elit ad commodo consequat ullamco magna aliqua nulla
          deserunt officia reprehenderit irure.
        </p>
        <p>LTR</p>
        {!!key && (
        ...
        {!!key && (
          <ReactFilm className={this.smallFilmCSS} height={316} key={`${key}-b`} nonce="a1b2c3d">
            <img alt="Cat 01" src="image/01.jpg" />
            <img alt="Cat 02" src="image/02.jpg" />
          </ReactFilm>
        )}
        ...
        {!!key && (
          <ReactFilm key={`${key}-e`} nonce="a1b2c3d">
            <ol className={this.listFilmItemCSS}>
              <li>A</li>
              <li>B</li>
              <li>C</li>
            </ol>
        ...
        {!!key && (
          <ReactFilm dir="rtl" key={`${key}-f`} nonce="a1b2c3d">
            <ul className={this.listFilmItemCSS}>
              <li>A</li>
              <li>B</li>
              <li>C</li>
            </ul>
        ...
        <p>
          Sunt nostrud amet commodo consectetur culpa incididunt voluptate. Mollit tempor tempor nostrud ad non
          excepteur reprehenderit ea. Cillum mollit reprehenderit mollit minim eiusmod deserunt reprehenderit. Sit
          cupidatat laborum dolore et magna duis Lorem aute sint fugiat sunt sunt. Sit non nostrud aliquip et nisi ad
          ullamco aute proident enim sit sit consectetur velit. Enim excepteur voluptate culpa anim laborum commodo eu
          excepteur.
        </p>
        <p>
          ...
          fugiat. Id non amet adipisicing non ipsum pariatur. Ad mollit ea culpa enim nostrud exercitation occaecat
          velit aute esse. Reprehenderit sint et duis veniam excepteur duis irure aliquip amet. Deserunt ullamco
          incididunt Lorem excepteur est ea ipsum.
        </p>
        <p>
          Excepteur et culpa fugiat occaecat labore cillum commodo aute aliqua est occaecat incididunt commodo
          voluptate. Non cillum aliquip duis voluptate mollit irure in. Cillum cupidatat voluptate ullamco eiusmod amet
          officia laboris commodo occaecat.
        </p>
        <p>
